...
public class Configurations implements Serializable {
    public static  String FILE_ADMINS = "./data/admins.ser";
    public static  String FILE_AGENCIES = "./data/agencies.ser";
    ...
    public static long milisseconds_time_pause_withdrow_account = 5000; //tempo para pausar as operações da conta poupança
    public static long second_time_waiting_to_pay_credite_account = 5; //tempo para esperar na combraça da divida
    public static long second_time_waiting_to_move_account = 10; //tempo aplicar politicas em contas
